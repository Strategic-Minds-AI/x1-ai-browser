    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Image src="https://media.base44.com/images/public/6a837c8e995cc4824aabf594/62e5d6b9c_generated_image.png" alt="X1 AI Browser" className="w-9 h-9 shrink-0" fittingType="fit" />
            <span className="font-heading font-bold text-lg">X1 AI Browser</span>
          </div>
      ...
      <section className="relative pt-32 pb-20 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            X1 AI Browser makes the web as reliable and programmable as APIs. Spin up browsers,
      ...
      <footer className="border-t border-border py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Image src="https://media.base44.com/images/public/6a837c8e995cc4824aabf594/62e5d6b9c_generated_image.png" alt="X1 AI Browser" className="w-7 h-7 shrink-0" fittingType="fit" />
            <span className="font-heading font-semibold">X1 AI Browser</span>
